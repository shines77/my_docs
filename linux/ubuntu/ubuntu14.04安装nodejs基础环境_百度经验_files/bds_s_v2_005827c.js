...
(function() {
    ...
    var F = window,
        ...
        h = [],
        O = "",
        C = {}, S = V.getElementById("bdshare_js").attributes.data,
    ...
    var Z = {
        ...
        bdStatistics: location.protocol === 'https:' ? 'https://gsp0.baidu.com/5foZdDe71MgCo2Kml5_Y_D3/commit' : "http://share.baidu.com/commit",
        ...
        _jump: function(AX, AW, B, AE, AD) {
            ...
            var z = AV.bdStatistics + r + "&t=" + Math.random();
            if (AX != "goWebsite") {
