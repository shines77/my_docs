...
LZMA2 是 `.xz` 格式的主要压缩算法，与 LZMA 相比，它在设计上就具有更好的多线程支持 [[6]](#articel6)。XZ Utils 利用了这一点，提供了多线程压缩功能，允许它利用多个CPU核心来加速大型文件的压缩过程 [[2]](#articel2)。Snippet 13表明可以通过命令行参数控制多线程。
