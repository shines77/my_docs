...
2. 将语法文件放入 Sublime Text 的 Packages 目录：
   ...
   - 找到你的 Sublime Text 的 Packages 目录。通常在Windows上位于`%APPDATA%\Sublime Text 3\Packages\`，在 Mac 上位于 `~/Library/Application Support/Sublime Text 3/Packages/`。
